...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	32e58593          	addi	a1,a1,814 # 1340 <statistics+0x80>
      1a:	8532                	mv	a0,a2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	2fc58593          	addi	a1,a1,764 # 1350 <statistics+0x90>
      5c:	4509                	li	a0,2
      5e:	08e010ef          	jal	10ec <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	2d650513          	addi	a0,a0,726 # 1358 <statistics+0x98>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	3d270713          	addi	a4,a4,978 # 147c <statistics+0x1bc>
    ...
    panic("runcmd");
      ...
      c6:	29e50513          	addi	a0,a0,670 # 1360 <statistics+0xa0>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	28c58593          	addi	a1,a1,652 # 1368 <statistics+0xa8>
      e4:	4509                	li	a0,2
      e6:	006010ef          	jal	10ec <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     114:	26858593          	addi	a1,a1,616 # 1378 <statistics+0xb8>
     118:	4509                	li	a0,2
     11a:	7d3000ef          	jal	10ec <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     176:	21650513          	addi	a0,a0,534 # 1388 <statistics+0xc8>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	ee4b0b13          	addi	s6,s6,-284 # 13b0 <statistics+0xf0>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e6:	eae50513          	addi	a0,a0,-338 # 1390 <statistics+0xd0>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     5a6:	e1660613          	addi	a2,a2,-490 # 13b8 <statistics+0xf8>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5da:	e02b0b13          	addi	s6,s6,-510 # 13d8 <statistics+0x118>
  ...
  return ret;
     ...
     60c:	db850513          	addi	a0,a0,-584 # 13c0 <statistics+0x100>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     65a:	d7250513          	addi	a0,a0,-654 # 13c8 <statistics+0x108>
...
0000000000000682 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     6a2:	d4260613          	addi	a2,a2,-702 # 13e0 <statistics+0x120>
     6a6:	85a6                	mv	a1,s1
     6a8:	854a                	mv	a0,s2
...
00000000000006e2 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     700:	ceca0a13          	addi	s4,s4,-788 # 13e8 <statistics+0x128>
  ...
  if(peek(ps, es, ";")){
     ...
     72a:	cca60613          	addi	a2,a2,-822 # 13f0 <statistics+0x130>
     72e:	85ce                	mv	a1,s3
     730:	854a                	mv	a0,s2
...
000000000000076a <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     780:	c3c60613          	addi	a2,a2,-964 # 13b8 <statistics+0xf8>
  ...
  if(!peek(ps, es, ")"))
     ...
     7a4:	c6860613          	addi	a2,a2,-920 # 1408 <statistics+0x148>
     7a8:	85ca                	mv	a1,s2
     7aa:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7da:	c2250513          	addi	a0,a0,-990 # 13f8 <statistics+0x138>
     7de:	86dff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7e2:	00001517          	auipc	a0,0x1
     7e6:	c2e50513          	addi	a0,a0,-978 # 1410 <statistics+0x150>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     80e:	c8a70713          	addi	a4,a4,-886 # 1494 <statistics+0x1d4>
...
000000000000086e <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     89e:	aae60613          	addi	a2,a2,-1362 # 1348 <statistics+0x88>
     8a2:	85a6                	mv	a1,s1
     8a4:	854a                	mv	a0,s2
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8cc:	b6058593          	addi	a1,a1,-1184 # 1428 <statistics+0x168>
     8d0:	4509                	li	a0,2
     8d2:	01b000ef          	jal	10ec <fprintf>
    panic("syntax");
     8d6:	00001517          	auipc	a0,0x1
     8da:	aea50513          	addi	a0,a0,-1302 # 13c0 <statistics+0x100>
...
00000000000008e2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8fc:	b4090913          	addi	s2,s2,-1216 # 1438 <statistics+0x178>
     900:	85a6                	mv	a1,s1
     902:	854a                	mv	a0,s2
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     9b4:	a9058593          	addi	a1,a1,-1392 # 1440 <statistics+0x180>
     9b8:	4509                	li	a0,2
     9ba:	732000ef          	jal	10ec <fprintf>
...
0000000000000d5c <rwlktest>:
.global rwlktest
rwlktest:
 li a7, SYS_rwlktest
     d5c:	02300893          	li	a7,35
 ecall
     d60:	00000073          	ecall
 ret
     d64:	8082                	ret

0000000000000d66 <cpupin>:
.global cpupin
cpupin:
 li a7, SYS_cpupin
     d66:	02400893          	li	a7,36
 ecall
     d6a:	00000073          	ecall
 ret
     d6e:	8082                	ret

0000000000000d70 <putc>:
...
putc(int fd, char c)
{
     ...
     d76:	1000                	addi	s0,sp,32
     d78:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     d7c:	4605                	li	a2,1
     d7e:	fef40593          	addi	a1,s0,-17
     d82:	f25ff0ef          	jal	ca6 <write>
}
     d86:	60e2                	ld	ra,24(sp)
     d88:	6442                	ld	s0,16(sp)
     d8a:	6105                	addi	sp,sp,32
     d8c:	8082                	ret

0000000000000d8e <printint>:
...
printint(int fd, long long xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     d9c:	c6d1                	beqz	a3,e28 <printint+0x9a>
     d9e:	0805d563          	bgez	a1,e28 <printint+0x9a>
    neg = 1;
    x = -xx;
     da2:	40b005b3          	neg	a1,a1
    neg = 1;
     da6:	4305                	li	t1,1
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     db0:	00000817          	auipc	a6,0x0
     db4:	70080813          	addi	a6,a6,1792 # 14b0 <digits>
     db8:	88ba                	mv	a7,a4
     dba:	0017051b          	addiw	a0,a4,1
     dbe:	872a                	mv	a4,a0
     dc0:	02c5f7b3          	remu	a5,a1,a2
     dc4:	97c2                	add	a5,a5,a6
     dc6:	0007c783          	lbu	a5,0(a5)
     dca:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     dce:	87ae                	mv	a5,a1
     dd0:	02c5d5b3          	divu	a1,a1,a2
     dd4:	0685                	addi	a3,a3,1
     dd6:	fec7f1e3          	bgeu	a5,a2,db8 <printint+0x2a>
  if(neg)
     dda:	00030c63          	beqz	t1,df2 <printint+0x64>
    buf[i++] = '-';
     dde:	fd050793          	addi	a5,a0,-48
     de2:	00878533          	add	a0,a5,s0
     de6:	02d00793          	li	a5,45
     dea:	fef50423          	sb	a5,-24(a0)
     dee:	0028871b          	addiw	a4,a7,2

  while(--i >= 0)
     df2:	02e05563          	blez	a4,e1c <printint+0x8e>
     df6:	fc26                	sd	s1,56(sp)
     df8:	377d                	addiw	a4,a4,-1
     dfa:	00e984b3          	add	s1,s3,a4
     dfe:	19fd                	addi	s3,s3,-1
     e00:	99ba                	add	s3,s3,a4
     e02:	1702                	slli	a4,a4,0x20
     e04:	9301                	srli	a4,a4,0x20
     e06:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     e0a:	0004c583          	lbu	a1,0(s1)
     e0e:	854a                	mv	a0,s2
     e10:	f61ff0ef          	jal	d70 <putc>
  while(--i >= 0)
     e14:	14fd                	addi	s1,s1,-1
     e16:	ff349ae3          	bne	s1,s3,e0a <printint+0x7c>
     e1a:	74e2                	ld	s1,56(sp)
}
     e1c:	60a6                	ld	ra,72(sp)
     e1e:	6406                	ld	s0,64(sp)
     e20:	7942                	ld	s2,48(sp)
     e22:	79a2                	ld	s3,40(sp)
     e24:	6161                	addi	sp,sp,80
     e26:	8082                	ret
  neg = 0;
     e28:	4301                	li	t1,0
     e2a:	bfbd                	j	da8 <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     e36:	0005c483          	lbu	s1,0(a1)
     e3a:	22048363          	beqz	s1,1060 <vprintf+0x234>
  ...
  for(i = 0; fmt[i]; i++){
     ...
     e58:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
     e5c:	06400c13          	li	s8,100
     e60:	a00d                	j	e82 <vprintf+0x56>
        putc(fd, c0);
     e62:	85a6                	mv	a1,s1
     e64:	855a                	mv	a0,s6
     e66:	f0bff0ef          	jal	d70 <putc>
     e6a:	a019                	j	e70 <vprintf+0x44>
    } else if(state == '%'){
     e6c:	03598363          	beq	s3,s5,e92 <vprintf+0x66>
  for(i = 0; fmt[i]; i++){
     e70:	0019079b          	addiw	a5,s2,1
     e74:	893e                	mv	s2,a5
     e76:	873e                	mv	a4,a5
     e78:	97d2                	add	a5,a5,s4
     e7a:	0007c483          	lbu	s1,0(a5)
     e7e:	1c048a63          	beqz	s1,1052 <vprintf+0x226>
    c0 = fmt[i] & 0xff;
     e82:	0004879b          	sext.w	a5,s1
    if(state == 0){
     e86:	fe0993e3          	bnez	s3,e6c <vprintf+0x40>
      if(c0 == '%'){
     e8a:	fd579ce3          	bne	a5,s5,e62 <vprintf+0x36>
        state = '%';
     e8e:	89be                	mv	s3,a5
     e90:	b7c5                	j	e70 <vprintf+0x44>
      if(c0) c1 = fmt[i+1] & 0xff;
     e92:	00ea06b3          	add	a3,s4,a4
     e96:	0016c603          	lbu	a2,1(a3)
      if(c1) c2 = fmt[i+2] & 0xff;
     e9a:	1c060863          	beqz	a2,106a <vprintf+0x23e>
      if(c0 == 'd'){
     e9e:	03878763          	beq	a5,s8,ecc <vprintf+0xa0>
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
     ea2:	f9478693          	addi	a3,a5,-108
     ea6:	0016b693          	seqz	a3,a3
     eaa:	f9c60593          	addi	a1,a2,-100
     eae:	e99d                	bnez	a1,ee4 <vprintf+0xb8>
     eb0:	ca95                	beqz	a3,ee4 <vprintf+0xb8>
     ...
     ed8:	855a                	mv	a0,s6
     eda:	eb5ff0ef          	jal	d8e <printint>
     ede:	8ba6                	mv	s7,s1
      state = 0;
     ee0:	4981                	li	s3,0
     ee2:	b779                	j	e70 <vprintf+0x44>
      if(c1) c2 = fmt[i+2] & 0xff;
     ee4:	9752                	add	a4,a4,s4
     ee6:	00274583          	lbu	a1,2(a4)
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     eea:	f9460713          	addi	a4,a2,-108
     eee:	00173713          	seqz	a4,a4
     ef2:	8f75                	and	a4,a4,a3
     ef4:	f9c58513          	addi	a0,a1,-100
     ef8:	18051363          	bnez	a0,107e <vprintf+0x252>
     efc:	18070163          	beqz	a4,107e <vprintf+0x252>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     f26:	855a                	mv	a0,s6
     f28:	e67ff0ef          	jal	d8e <printint>
     f2c:	8ba6                	mv	s7,s1
      state = 0;
     f2e:	4981                	li	s3,0
     f30:	b781                	j	e70 <vprintf+0x44>
     ...
     f3e:	855a                	mv	a0,s6
     f40:	e4fff0ef          	jal	d8e <printint>
        i += 1;
     f44:	2905                	addiw	s2,s2,1
        printint(fd, va_arg(ap, uint64), 10, 0);
     f46:	8ba6                	mv	s7,s1
      state = 0;
     f48:	4981                	li	s3,0
     f4a:	b71d                	j	e70 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     f72:	855a                	mv	a0,s6
     f74:	e1bff0ef          	jal	d8e <printint>
     f78:	8ba6                	mv	s7,s1
      state = 0;
     f7a:	4981                	li	s3,0
     f7c:	bdd5                	j	e70 <vprintf+0x44>
     ...
     fae:	4981                	li	s3,0
        i += 2;
     fb0:	b5c1                	j	e70 <vprintf+0x44>
     fb2:	e466                	sd	s9,8(sp)
        printptr(fd, va_arg(ap, uint64));
     fb4:	008b8793          	addi	a5,s7,8
     fb8:	8cbe                	mv	s9,a5
     fba:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
     fbe:	03000593          	li	a1,48
     fc2:	855a                	mv	a0,s6
     fc4:	dadff0ef          	jal	d70 <putc>
  putc(fd, 'x');
     fc8:	07800593          	li	a1,120
     fcc:	855a                	mv	a0,s6
     fce:	da3ff0ef          	jal	d70 <putc>
     fd2:	44c1                	li	s1,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fd4:	00000b97          	auipc	s7,0x0
     fd8:	4dcb8b93          	addi	s7,s7,1244 # 14b0 <digits>
     fdc:	03c9d793          	srli	a5,s3,0x3c
     fe0:	97de                	add	a5,a5,s7
     fe2:	0007c583          	lbu	a1,0(a5)
     fe6:	855a                	mv	a0,s6
     fe8:	d89ff0ef          	jal	d70 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     fec:	0992                	slli	s3,s3,0x4
     fee:	34fd                	addiw	s1,s1,-1
     ff0:	f4f5                	bnez	s1,fdc <vprintf+0x1b0>
        printptr(fd, va_arg(ap, uint64));
     ff2:	8be6                	mv	s7,s9
      state = 0;
     ff4:	4981                	li	s3,0
     ff6:	6ca2                	ld	s9,8(sp)
     ff8:	bda5                	j	e70 <vprintf+0x44>
        putc(fd, va_arg(ap, uint32));
     ffa:	008b8493          	addi	s1,s7,8
     ffe:	000bc583          	lbu	a1,0(s7)
    1002:	855a                	mv	a0,s6
    1004:	d6dff0ef          	jal	d70 <putc>
    1008:	8ba6                	mv	s7,s1
      state = 0;
    100a:	4981                	li	s3,0
    100c:	b595                	j	e70 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    100e:	008b8993          	addi	s3,s7,8
    1012:	000bb483          	ld	s1,0(s7)
    1016:	cc91                	beqz	s1,1032 <vprintf+0x206>
        for(; *s; s++)
    1018:	0004c583          	lbu	a1,0(s1)
    101c:	c985                	beqz	a1,104c <vprintf+0x220>
          putc(fd, *s);
    101e:	855a                	mv	a0,s6
    1020:	d51ff0ef          	jal	d70 <putc>
        for(; *s; s++)
    1024:	0485                	addi	s1,s1,1
    1026:	0004c583          	lbu	a1,0(s1)
    102a:	f9f5                	bnez	a1,101e <vprintf+0x1f2>
        if((s = va_arg(ap, char*)) == 0)
    102c:	8bce                	mv	s7,s3
      state = 0;
    102e:	4981                	li	s3,0
    1030:	b581                	j	e70 <vprintf+0x44>
          s = "(null)";
    1032:	00000497          	auipc	s1,0x0
    1036:	41e48493          	addi	s1,s1,1054 # 1450 <statistics+0x190>
        for(; *s; s++)
    103a:	02800593          	li	a1,40
    103e:	b7c5                	j	101e <vprintf+0x1f2>
        putc(fd, '%');
    1040:	85be                	mv	a1,a5
    1042:	855a                	mv	a0,s6
    1044:	d2dff0ef          	jal	d70 <putc>
      state = 0;
    1048:	4981                	li	s3,0
    104a:	b51d                	j	e70 <vprintf+0x44>
        if((s = va_arg(ap, char*)) == 0)
    104c:	8bce                	mv	s7,s3
      state = 0;
    104e:	4981                	li	s3,0
    1050:	b505                	j	e70 <vprintf+0x44>
    1052:	6906                	ld	s2,64(sp)
    ...
    1060:	60e6                	ld	ra,88(sp)
    1062:	6446                	ld	s0,80(sp)
    1064:	64a6                	ld	s1,72(sp)
    1066:	6125                	addi	sp,sp,96
    1068:	8082                	ret
      if(c0 == 'd'){
    106a:	06400713          	li	a4,100
    106e:	e4e78fe3          	beq	a5,a4,ecc <vprintf+0xa0>
      } else if(c0 == 'l' && c1 == 'd'){
    1072:	f9478693          	addi	a3,a5,-108
    1076:	0016b693          	seqz	a3,a3
      c1 = c2 = 0;
    107a:	85b2                	mv	a1,a2
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    107c:	4701                	li	a4,0
      } else if(c0 == 'u'){
    107e:	07500513          	li	a0,117
    1082:	e8a78ce3          	beq	a5,a0,f1a <vprintf+0xee>
      } else if(c0 == 'l' && c1 == 'u'){
    1086:	f8b60513          	addi	a0,a2,-117
    108a:	e119                	bnez	a0,1090 <vprintf+0x264>
    108c:	ea0693e3          	bnez	a3,f32 <vprintf+0x106>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    1090:	f8b58513          	addi	a0,a1,-117
    1094:	e119                	bnez	a0,109a <vprintf+0x26e>
    1096:	ea071be3          	bnez	a4,f4c <vprintf+0x120>
      } else if(c0 == 'x'){
    109a:	07800513          	li	a0,120
    109e:	eca784e3          	beq	a5,a0,f66 <vprintf+0x13a>
      } else if(c0 == 'l' && c1 == 'x'){
    10a2:	f8860613          	addi	a2,a2,-120
    10a6:	e219                	bnez	a2,10ac <vprintf+0x280>
    10a8:	ec069be3          	bnez	a3,f7e <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    10ac:	f8858593          	addi	a1,a1,-120
    10b0:	e199                	bnez	a1,10b6 <vprintf+0x28a>
    10b2:	ee0713e3          	bnez	a4,f98 <vprintf+0x16c>
      } else if(c0 == 'p'){
    10b6:	07000713          	li	a4,112
    10ba:	eee78ce3          	beq	a5,a4,fb2 <vprintf+0x186>
      } else if(c0 == 'c'){
    10be:	06300713          	li	a4,99
    10c2:	f2e78ce3          	beq	a5,a4,ffa <vprintf+0x1ce>
      } else if(c0 == 's'){
    10c6:	07300713          	li	a4,115
    10ca:	f4e782e3          	beq	a5,a4,100e <vprintf+0x1e2>
      } else if(c0 == '%'){
    10ce:	02500713          	li	a4,37
    10d2:	f6e787e3          	beq	a5,a4,1040 <vprintf+0x214>
        putc(fd, '%');
    10d6:	02500593          	li	a1,37
    10da:	855a                	mv	a0,s6
    10dc:	c95ff0ef          	jal	d70 <putc>
        putc(fd, c0);
    10e0:	85a6                	mv	a1,s1
    10e2:	855a                	mv	a0,s6
    10e4:	c8dff0ef          	jal	d70 <putc>
      state = 0;
    10e8:	4981                	li	s3,0
    10ea:	b359                	j	e70 <vprintf+0x44>

00000000000010ec <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    10ec:	715d                	addi	sp,sp,-80
    10ee:	ec06                	sd	ra,24(sp)
    10f0:	e822                	sd	s0,16(sp)
    10f2:	1000                	addi	s0,sp,32
    10f4:	e010                	sd	a2,0(s0)
    10f6:	e414                	sd	a3,8(s0)
    10f8:	e818                	sd	a4,16(s0)
    10fa:	ec1c                	sd	a5,24(s0)
    10fc:	03043023          	sd	a6,32(s0)
    1100:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    1104:	8622                	mv	a2,s0
    1106:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    110a:	d23ff0ef          	jal	e2c <vprintf>
}
...
printf(const char *fmt, ...)
{
    ...
    111e:	e40c                	sd	a1,8(s0)
    1120:	e810                	sd	a2,16(s0)
    1122:	ec14                	sd	a3,24(s0)
    1124:	f018                	sd	a4,32(s0)
    1126:	f41c                	sd	a5,40(s0)
    1128:	03043823          	sd	a6,48(s0)
    112c:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    1130:	00840613          	addi	a2,s0,8
    1134:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    1138:	85aa                	mv	a1,a0
    113a:	4505                	li	a0,1
    113c:	cf1ff0ef          	jal	e2c <vprintf>
}
    1140:	60e2                	ld	ra,24(sp)
    1142:	6442                	ld	s0,16(sp)
    1144:	6125                	addi	sp,sp,96
    1146:	8082                	ret

0000000000001148 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    114c:	e022                	sd	s0,0(sp)
    114e:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    1150:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1154:	00001797          	auipc	a5,0x1
    1158:	ebc7b783          	ld	a5,-324(a5) # 2010 <freep>
    115c:	a039                	j	116a <free+0x22>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    115e:	6398                	ld	a4,0(a5)
    1160:	00e7e463          	bltu	a5,a4,1168 <free+0x20>
    1164:	00e6ea63          	bltu	a3,a4,1178 <free+0x30>
{
    1168:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    116a:	fed7fae3          	bgeu	a5,a3,115e <free+0x16>
    116e:	6398                	ld	a4,0(a5)
    1170:	00e6e463          	bltu	a3,a4,1178 <free+0x30>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1174:	fee7eae3          	bltu	a5,a4,1168 <free+0x20>
      break;
  if(bp + bp->s.size == p->s.ptr){
    1178:	ff852583          	lw	a1,-8(a0)
    117c:	6390                	ld	a2,0(a5)
    117e:	02059813          	slli	a6,a1,0x20
    1182:	01c85713          	srli	a4,a6,0x1c
    1186:	9736                	add	a4,a4,a3
    1188:	02e60563          	beq	a2,a4,11b2 <free+0x6a>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    118c:	fec53823          	sd	a2,-16(a0)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    1190:	4790                	lw	a2,8(a5)
    1192:	02061593          	slli	a1,a2,0x20
    1196:	01c5d713          	srli	a4,a1,0x1c
    119a:	973e                	add	a4,a4,a5
    119c:	02e68263          	beq	a3,a4,11c0 <free+0x78>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    11a0:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    ...
    11aa:	60a2                	ld	ra,8(sp)
    11ac:	6402                	ld	s0,0(sp)
    ...
    11cc:	bfd1                	j	11a0 <free+0x58>

00000000000011ce <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    11ce:	7139                	addi	sp,sp,-64
    11d0:	fc06                	sd	ra,56(sp)
    11d2:	f822                	sd	s0,48(sp)
    11d4:	f04a                	sd	s2,32(sp)
    11d6:	ec4e                	sd	s3,24(sp)
    11d8:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    11da:	02051993          	slli	s3,a0,0x20
    11de:	0209d993          	srli	s3,s3,0x20
    11e2:	09bd                	addi	s3,s3,15
    11e4:	0049d993          	srli	s3,s3,0x4
    11e8:	2985                	addiw	s3,s3,1
    11ea:	894e                	mv	s2,s3
  if((prevp = freep) == 0){
    11ec:	00001517          	auipc	a0,0x1
    11f0:	e2453503          	ld	a0,-476(a0) # 2010 <freep>
    11f4:	c905                	beqz	a0,1224 <malloc+0x56>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11fa:	09377663          	bgeu	a4,s3,1286 <malloc+0xb8>
  ...
  if(nu < 4096)
    1206:	8a4e                	mv	s4,s3
    1208:	6705                	lui	a4,0x1
    120a:	00e9f363          	bgeu	s3,a4,1210 <malloc+0x42>
    120e:	6a05                	lui	s4,0x1
    1210:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    1214:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1218:	00001497          	auipc	s1,0x1
    121c:	df848493          	addi	s1,s1,-520 # 2010 <freep>
  if(p == SBRK_ERROR)
    1220:	5afd                	li	s5,-1
    1222:	a83d                	j	1260 <malloc+0x92>
    ...
    1230:	e5c78793          	addi	a5,a5,-420 # 2088 <base>
    1234:	00001717          	auipc	a4,0x1
    1238:	dcf73e23          	sd	a5,-548(a4) # 2010 <freep>
    123c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    123e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1242:	b7d1                	j	1206 <malloc+0x38>
        prevp->s.ptr = p->s.ptr;
    1244:	6398                	ld	a4,0(a5)
    1246:	e118                	sd	a4,0(a0)
    1248:	a899                	j	129e <malloc+0xd0>
  hp->s.size = nu;
    124a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    124e:	0541                	addi	a0,a0,16
    1250:	ef9ff0ef          	jal	1148 <free>
  return freep;
    1254:	6088                	ld	a0,0(s1)
      if((p = morecore(nunits)) == 0)
    1256:	c125                	beqz	a0,12b6 <malloc+0xe8>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1258:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    125a:	4798                	lw	a4,8(a5)
    125c:	03277163          	bgeu	a4,s2,127e <malloc+0xb0>
    if(p == freep)
    1260:	6098                	ld	a4,0(s1)
    1262:	853e                	mv	a0,a5
    1264:	fef71ae3          	bne	a4,a5,1258 <malloc+0x8a>
  p = sbrk(nu * sizeof(Header));
    1268:	8552                	mv	a0,s4
    126a:	9e9ff0ef          	jal	c52 <sbrk>
  if(p == SBRK_ERROR)
    126e:	fd551ee3          	bne	a0,s5,124a <malloc+0x7c>
        return 0;
    1272:	4501                	li	a0,0
    ...
    127c:	a03d                	j	12aa <malloc+0xdc>
    127e:	74a2                	ld	s1,40(sp)
    1280:	6a42                	ld	s4,16(sp)
    1282:	6aa2                	ld	s5,8(sp)
    1284:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    1286:	fae90fe3          	beq	s2,a4,1244 <malloc+0x76>
        p->s.size -= nunits;
    ...
    12be:	b7f5                	j	12aa <malloc+0xdc>

00000000000012c0 <statistics>:
...
statistics(void *buf, int sz)
{
    ...
    12c6:	ec26                	sd	s1,24(sp)
    12c8:	e84a                	sd	s2,16(sp)
    12ca:	e44e                	sd	s3,8(sp)
    12cc:	e052                	sd	s4,0(sp)
  ...
  fd = open("statistics", O_RDONLY);
    ...
    12da:	18250513          	addi	a0,a0,386 # 1458 <statistics+0x198>
    12de:	9e9ff0ef          	jal	cc6 <open>
  if(fd < 0) {
    12e2:	02054e63          	bltz	a0,131e <statistics+0x5e>
    12e6:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    12e8:	4481                	li	s1,0
    12ea:	01205e63          	blez	s2,1306 <statistics+0x46>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    12ee:	4099063b          	subw	a2,s2,s1
    12f2:	009a05b3          	add	a1,s4,s1
    12f6:	854e                	mv	a0,s3
    12f8:	9a7ff0ef          	jal	c9e <read>
    12fc:	00054563          	bltz	a0,1306 <statistics+0x46>
      break;
    }
    i += n;
    1300:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    1302:	ff24c6e3          	blt	s1,s2,12ee <statistics+0x2e>
  }
  close(fd);
    1306:	854e                	mv	a0,s3
    1308:	9a7ff0ef          	jal	cae <close>
  return i;
}
    130c:	8526                	mv	a0,s1
    130e:	70a2                	ld	ra,40(sp)
    1310:	7402                	ld	s0,32(sp)
    1312:	64e2                	ld	s1,24(sp)
    1314:	6942                	ld	s2,16(sp)
    1316:	69a2                	ld	s3,8(sp)
    1318:	6a02                	ld	s4,0(sp)
    131a:	6145                	addi	sp,sp,48
    131c:	8082                	ret
      fprintf(2, "stats: open failed\n");
    131e:	00000597          	auipc	a1,0x0
    1322:	14a58593          	addi	a1,a1,330 # 1468 <statistics+0x1a8>
    1326:	4509                	li	a0,2
    1328:	dc5ff0ef          	jal	10ec <fprintf>
      exit(1);
    132c:	4505                	li	a0,1
    132e:	959ff0ef          	jal	c86 <exit>
