...
main(void)
{
  ...
  20:	85d6                	mv	a1,s5
  22:	855a                	mv	a0,s6
  24:	121000ef          	jal	944 <statistics>
  28:	8a2a                	mv	s4,a0
    for (i = 0; i < n; i++) {
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 438:	5bc80813          	addi	a6,a6,1468 # 9f0 <digits>
 43c:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 65c:	398b8b93          	addi	s7,s7,920 # 9f0 <digits>
 ...
 6ba:	30a48493          	addi	s1,s1,778 # 9c0 <statistics+0x7c>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 8b4:	76078793          	addi	a5,a5,1888 # 2010 <base>
...
statistics(void *buf, int sz)
{
 ...
 95e:	06e50513          	addi	a0,a0,110 # 9c8 <statistics+0x84>
 ...
 9a6:	03658593          	addi	a1,a1,54 # 9d8 <statistics+0x94>
 9aa:	4509                	li	a0,2
