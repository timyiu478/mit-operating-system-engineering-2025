...
main(int argc, char *argv[])
{
  ...
  5a:	99a58593          	addi	a1,a1,-1638 # 9f0 <statistics+0x9a>
  5e:	4509                	li	a0,2
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 44a:	5fa80813          	addi	a6,a6,1530 # a40 <digits>
 44e:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 66e:	3d6b8b93          	addi	s7,s7,982 # a40 <digits>
 ...
 6cc:	34848493          	addi	s1,s1,840 # a10 <statistics+0xba>
        for(; *s; s++)
...
statistics(void *buf, int sz)
{
 ...
 970:	0ac50513          	addi	a0,a0,172 # a18 <statistics+0xc2>
 ...
 9b8:	07458593          	addi	a1,a1,116 # a28 <statistics+0xd2>
 9bc:	4509                	li	a0,2
